...
const GF_FilterRegister * EMSCRIPTEN_KEEPALIVE avidmx_register(GF_FilterSession *session)
{
#ifndef GPAC_DISABLE_AVILIB
...
void register_avidmx(void) {
    gf_filter_auto_register("avidmx", avidmx_register);
}
